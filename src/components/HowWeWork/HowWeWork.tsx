  ...
  const steps: Step[] = [
    {
      ...
      description: 'Заполняете форму на сайте или связываетесь с нами по телефону для консультации'
    },
    {
      id: 2,
      icon: <Phone size={32} />,
        ...
        <div className="how-we-work__content">
          <div className="how-we-work__header">
            ...
            <p className="how-we-work__subtitle">
              Ключевой этап - пробное занятие, после которого вы получаете честное понимание, подходит ребенку направление или нет.
            </p>
          </div>
